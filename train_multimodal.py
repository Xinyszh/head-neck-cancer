...
def train():
    ...
    parser.add_argument('--device', type=int, default=7, help="Choose gpu device.")
    parser.add_argument('--device_gpus', type=list, default=[5,6], help="Choose gpu device.")
    parser.add_argument('--log_dir', type=str, default='/jhcnas1/xinyi/head_neck_cancer/split', help="Address to store the log files.")
    ...
    if args.modal == 'T1_COR':
        before_data_size = (1, 45, 384, 384)
        after_data_size = (1, 45, 384, 384)
    elif args.modal == 'T1_TRA':
        before_data_size = (1, 70, 384, 384)
        after_data_size = (1, 70, 384, 384)
    elif args.modal == 'T2_TRA':
        before_data_size = (1, 36, 384,384)
        after_data_size = (1, 36, 384, 384)
